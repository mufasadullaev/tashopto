...
public partial class PerejegStartViewModel : ViewModelBase
{
    [ObservableProperty]
    ...
    public Action<PerejegStartResult?>? Close { get; set; }

    public PerejegStartViewModel()
    {
    ...
    private void Continue()
    {
        ...
        Close?.Invoke(new PerejegStartResult
        {
