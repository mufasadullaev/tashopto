...
public partial class WyrabotkaStartViewModel : ViewModelBase
{
    [ObservableProperty]
    ...
    public Action<WyrabotkaStartResult?>? Close { get; set; }

    public WyrabotkaStartViewModel()
    {
    ...
    private void Continue()
    {
        ...
        Close?.Invoke(new WyrabotkaStartResult
        {
